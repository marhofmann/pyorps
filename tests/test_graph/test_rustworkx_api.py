...
class TestRustworkxAPI(unittest.TestCase):
    ...
    def test_add_edge(self):
        ...
        # Call the method
        self.api.add_edge(0, 1, 2.5)

        # Verify the graph's add_edge method was called with correct parameters
        self.mock_graph_instance.add_edge.assert_called_once_with(0, 1, 2.5)
    ...
    def test_add_edges(self):
        ...
        # Call the method
        self.api.add_edges(from_nodes, to_nodes, cost)

        # Verify the graph's add_edges_from method was called with correct parameters
        self.mock_graph_instance.add_edges_from.assert_called_once()
        # Extract the argument passed to add_edges_from
        called_arg = self.mock_graph_instance.add_edges_from.call_args[0][0]
        # Verify it's a list of tuples (from_node, to_node, cost)
        self.assertEqual(list(called_arg), [(0, 1, 1.0), (1, 2, 2.0), (2, 3, 3.0)])
