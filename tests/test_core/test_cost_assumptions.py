...
class TestCostAssumptions(unittest.TestCase):
    ...
    def test_convert_df_to_cost_dict(self):
        ...
        result = ca._convert_df_to_cost_dict(df)
        ...
        with self.assertRaises(FormatError):
            ca._convert_df_to_cost_dict(df)
    ...
    def test_calculate_column_statistics(self):
        ...
        from pyorps.core.cost_assumptions import _calculate_column_statistics
        ...
        stats = _calculate_column_statistics(test_gdf, ['landuse', 'type', 'numeric'])
    ...
    def test_column_relationship_with_nulls_and_patterns(self):
        ...
        from pyorps.core.cost_assumptions import _column_shows_relationship_to_main_feature
        ...
        self.assertTrue(_column_shows_relationship_to_main_feature(gdf, 'main', 'side1'))

        # Test when multiple values present for each main value
        self.assertTrue(_column_shows_relationship_to_main_feature(gdf, 'main', 'side2'))

        # Test when only one value per main value (perfect correlation)
        self.assertTrue(_column_shows_relationship_to_main_feature(gdf, 'main', 'side3'))

        # Test with empty strings
        self.assertTrue(_column_shows_relationship_to_main_feature(gdf, 'main', 'side4'))
        ...
        self.assertFalse(_column_shows_relationship_to_main_feature(gdf_many_values, 'main', 'side'))
        ...
        self.assertFalse(_column_shows_relationship_to_main_feature(gdf_error_case, 'main', 'side'))
    ...
    def test_cost_dict_to_df_with_nested_dict(self):
        ...
        df = ca._cost_dict_to_df(nested_cost_dict)
    ...
    def test_column_relationship_detection_complete(self):
        ...
        result = _column_shows_relationship_to_main_feature(gdf_nulls, 'main', 'side')
        ...
        result = _column_shows_relationship_to_main_feature(gdf_multi, 'main', 'side')
        self.assertTrue(result)
        ...
        result = _column_shows_relationship_to_main_feature(empty_gdf, 'main', 'side')
    ...
    def test_calculate_column_statistics_edge_cases(self):
        ...
        stats = _calculate_column_statistics(gdf,
        ...
        stats = _calculate_column_statistics(problematic_gdf, ['complex_vals'])
